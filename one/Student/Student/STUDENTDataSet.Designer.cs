...
namespace Student {
    ...
    public partial class STUDENTDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public StudentRow AddStudentRow(string Sno, string Sname, string Ssex, string Sclass) {
            ...
            private void InitClass() {
                ...
                this.columnSclass.MaxLength = 30;
            }
...
namespace Student.STUDENTDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([Sno] = @Original_Sno) AND ((@IsNull_Sname = 1 AND [Sname] IS NULL) OR ([Sname] = @Original_Sname)) AND ((@IsNull_Ssex = 1 AND [Ssex] IS NULL) OR ([Ssex] = @Original_Ssex)) AND ((@IsNull_Sclass = 1 AND [Sclass] IS NULL) OR ([Sclass] = @Original_Sclass)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Sno], [Sname], [Ssex], [Sclass]) VALUES (@Sno, @Sna" +
                "me, @Ssex, @Sclass);\r\nSELECT Sno, Sname, Ssex, Sclass FROM Student WHERE (Sno = " +
                "@Sno)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Sno] = @Sno, [Sname] = @Sname, [Ssex] = @Ssex, [Sclass] = @Sclass WHERE (([Sno] = @Original_Sno) AND ((@IsNull_Sname = 1 AND [Sname] IS NULL) OR ([Sname] = @Original_Sname)) AND ((@IsNull_Ssex = 1 AND [Ssex] IS NULL) OR ([Ssex] = @Original_Ssex)) AND ((@IsNull_Sclass = 1 AND [Sclass] IS NULL) OR ([Sclass] = @Original_Sclass)));
SELECT Sno, Sname, Ssex, Sclass FROM Student WHERE (Sno = @Sno)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Sno, Sname, Ssex, Sclass FROM dbo.Student";
        ...
        public virtual int Delete(string Original_Sno, string Original_Sname, string Original_Ssex, string Original_Sclass) {
        ...
        public virtual int Insert(string Sno, string Sname, string Ssex, string Sclass) {
            if ((Sno == null)) {
        ...
        public virtual int Update(string Sno, string Sname, string Ssex, string Sclass, string Original_Sno, string Original_Sname, string Original_Ssex, string Original_Sclass) {
            if ((Sno == null)) {
                throw new global::System.ArgumentNullException("Sno");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Sname, string Ssex, string Sclass, string Original_Sno, string Original_Sname, string Original_Ssex, string Original_Sclass) {
            return this.Update(Original_Sno, Sname, Ssex, Sclass, Original_Sno, Original_Sname, Original_Ssex, Original_Sclass);
        }
    }
